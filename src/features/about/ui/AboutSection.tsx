    ...
    <section className="py-6 bg-white w-full overflow-hidden">
      <div className="container mx-auto px-4">
        <motion.div 
          ...
          className="flex flex-col md:flex-row justify-between items-center gap-8 mb-20"
        >
          ...
          <motion.div variants={fadeUpVariants} className="shrink-0">
            <Button className="rounded-2xl px-10 py-7 text-base font-bold bg-[#FF8A00] hover:bg-[#E67E00] text-white group transition-all duration-300 shadow-[0_10px_20px_rgba(255,138,0,0.2)] hover:shadow-[0_15px_30px_rgba(255,138,0,0.3)] active:scale-95">
              {t("getStarted")}
        ...
        >
          ...
          <motion.div variants={fadeUpVariants} className="lg:col-span-7 relative">
          ...
          {/* Content Side */}
          <motion.div variants={fadeUpVariants} className="lg:col-span-5 flex flex-col gap-8">
