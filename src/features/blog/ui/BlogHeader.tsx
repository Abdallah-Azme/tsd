...
export const BlogHeader: React.FC<BlogHeaderProps> = ({
  ...
  return (
    <div className="mb-12 space-y-4">
      <div className="inline-flex items-center gap-1 px-4 h-8 rounded-[100px] bg-[linear-gradient(180deg,rgba(181,86,18,0.65)_6.22%,rgba(26,66,125,0.65)_100%)] shadow-[inset_0px_0px_8px_#FFFFFF] backdrop-blur-sm">
